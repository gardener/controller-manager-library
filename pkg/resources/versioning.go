...
// Prepare vor kubernetes 1.17.
// It removes the type runtime.VersionedObjects and its usage in all the
// decoders

type versionedObjects interface {
	runtime.Object
	Last() runtime.Object
...
func UniversalDecoder(scheme *runtime.Scheme, decoder runtime.Decoder, versions ...schema.GroupVersion) runtime.Decoder {
	...
	return NewDefaultingCodecForScheme(scheme, nil, decoder, runtime.DisabledGroupVersioner, versioner)
}
