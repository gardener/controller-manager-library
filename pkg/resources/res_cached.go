...
func (this *_resource) getCached(namespace, name string) (Object, error) {
	var obj ObjectData
	informer, err := this.helper.I_lookupInformer(false, namespace)
	if err != nil {
		return nil, err
	}
...
func (this *_resource) ListCached(selector labels.Selector) (ret []Object, err error) {
	informer, err := this.helper.I_getInformer(false, "", nil)
	if err != nil {
		return nil, err
	}
	if selector == nil {
...
func (this *namespacedResource) getLister() (NamespacedLister, error) {
	if this.lister == nil {
		informer, err := this.resource.helper.I_lookupInformer(false, this.namespace)
		if err != nil {
			return nil, err
		}
