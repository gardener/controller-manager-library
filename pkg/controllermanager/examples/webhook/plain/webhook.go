...
import (
	...
	handler "github.com/gardener/controller-manager-library/pkg/controllermanager/webhook/admission/plain"
...
func (this *MyHandler) Handle(logger logger.LogContext, req handler.Request) admission.Response {
	if req.Object != nil {
		logger.Infof("found plain object %s", req.Object.ObjectName())
	}
