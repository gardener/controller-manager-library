...
var controlplanesResource = schema.GroupVersionResource{Group: "gardenextensions", Version: "v1alpha1", Resource: "controlplanes"}

var controlplanesKind = schema.GroupVersionKind{Group: "gardenextensions", Version: "v1alpha1", Kind: "ControlPlane"}

// Data takes name of the controlPlane, and returns the corresponding controlPlane object, and an error if there is any.
